program test_linked_charged_disc
  ...
  call initChargedDisc(charged_disc1,1.0D+00)
  call initChargedDisc(charged_disc2,10.0D+00)
  call initChargedDisc(charged_disc3,100.0D+00)
  call initChargedDisc(charged_disc4,1000.0D+00)
  call initChargedDisc(charged_disc5,10000.0D+00)
